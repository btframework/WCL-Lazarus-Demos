...
type
  ...
  IXMLDOMImplementationDisp = dispinterface
    ['{2933BF8F-7B36-11D2-B20E-00C04F983E60}']
    function  hasFeature(const feature: WideString;
      const version: WideString): WordBool; dispid 145;
  end;
  ...
  IXMLDOMNode = interface(IDispatch)
    ...
    function insertBefore(const newChild: IXMLDOMNode;
      refChild: OleVariant): IXMLDOMNode; safecall;
    ...
    function transformNode(
      const stylesheet: IXMLDOMNode): WideString; safecall;
    function selectNodes(
      const queryString: WideString): IXMLDOMNodeList; safecall;
    function selectSingleNode(
      const queryString: WideString): IXMLDOMNode; safecall;
  ...
  IXMLDOMNodeDisp = dispinterface
    ...
    function insertBefore(const newChild: IXMLDOMNode;
      refChild: OleVariant): IXMLDOMNode; dispid 13;
    function replaceChild(const newChild: IXMLDOMNode;
    ...
    function transformNode(
      const stylesheet: IXMLDOMNode): WideString; dispid 28;
    function selectNodes(
      const queryString: WideString): IXMLDOMNodeList; dispid 29;
    function selectSingleNode(
      const queryString: WideString): IXMLDOMNode; dispid 30;
  ...
  IXMLDOMDocument = interface(IXMLDOMNode)
    ...
    function createCDATASection(
      const data: WideString): IXMLDOMCDATASection; safecall;
    ...
    function createAttribute(
      const name: WideString): IXMLDOMAttribute; safecall;
    function createEntityReference(
      const name: WideString): IXMLDOMEntityReference; safecall;
    function getElementsByTagName(
      const tagName: WideString): IXMLDOMNodeList; safecall;
    ...
    property preserveWhiteSpace: WordBool read Get_preserveWhiteSpace
  ...
  IXMLDOMDocumentDisp = dispinterface
    ...
    function createElement(
      const tagName: WideString): IXMLDOMElement; dispid 41;
    ...
    function createCDATASection(
      const data: WideString): IXMLDOMCDATASection; dispid 45;
    function createProcessingInstruction(const target: WideString;
      const data: WideString): IXMLDOMProcessingInstruction; dispid 46;
    function createAttribute(
      const name: WideString): IXMLDOMAttribute; dispid 47;
    function createEntityReference(
      const name: WideString): IXMLDOMEntityReference; dispid 49;
    function getElementsByTagName(
      const tagName: WideString): IXMLDOMNodeList; dispid 50;
    function createNode(type_: OleVariant; const name: WideString;
  ...
  IXMLDOMElement = interface(IXMLDOMNode)
    ...
    function setAttributeNode(
      const DOMAttribute: IXMLDOMAttribute): IXMLDOMAttribute; safecall;
  ...
  IXMLDOMElementDisp = dispinterface
    ...
    procedure setAttribute(
      const name: WideString; value: OleVariant); dispid 100;
    procedure removeAttribute(const name: WideString); dispid 101;
    function getAttributeNode(
      const name: WideString): IXMLDOMAttribute; dispid 102;
    function setAttributeNode(
      const DOMAttribute: IXMLDOMAttribute): IXMLDOMAttribute; dispid 103;
    function removeAttributeNode(
      const DOMAttribute: IXMLDOMAttribute): IXMLDOMAttribute; dispid 104;
    function getElementsByTagName(
      const tagName: WideString): IXMLDOMNodeList; dispid 105;
  ...
  IXMLDOMCharacterData = interface(IXMLDOMNode)
    ...
    function Get_length: Integer; safecall;
    function substringData(offset: Integer;
      count: Integer): WideString; safecall;
  ...
  IXMLDOMCharacterDataDisp = dispinterface
    ...
    function substringData(offset: Integer;
      count: Integer): WideString; dispid 111;
  ...
  IXTLRuntime = interface(IXMLDOMNode)
    ...
    function formatIndex(lIndex: Integer;
      const bstrFormat: WideString): WideString; safecall;
    function formatNumber(dblNumber: Double;
      const bstrFormat: WideString): WideString; safecall;
  ...
  IXTLRuntimeDisp = dispinterface
    ...
    function formatIndex(lIndex: Integer;
      const bstrFormat: WideString): WideString; dispid 192;
    function formatNumber(dblNumber: Double;
      const bstrFormat: WideString): WideString; dispid 193;
    function formatDate(varDate: OleVariant; const bstrFormat: WideString;
  ...
  IXMLHttpRequestDisp = dispinterface
    ...
    procedure open(const bstrMethod: WideString; const bstrUrl: WideString;
      varAsync: OleVariant; bstrUser: OleVariant;
      bstrPassword: OleVariant); dispid 1;
    procedure setRequestHeader(const bstrHeader: WideString;
      const bstrValue: WideString); dispid 2;
    function getResponseHeader(
      const bstrHeader: WideString): WideString; dispid 3;
  ...
  IXMLDSOControl = interface(IDispatch)
    ...
    function Get_readyState: Integer; safecall;
    property XMLDocument: IXMLDOMDocument read Get_XMLDocument
      write Set_XMLDocument;
    property JavaDSOCompatible: Integer read Get_JavaDSOCompatible
      write Set_JavaDSOCompatible;
    property readyState: Integer read Get_readyState;
  end;
  ...
  IXMLDocument = interface(IDispatch)
    ...
    function createElement(vType: OleVariant;
      var1: OleVariant): IXMLElement; safecall;
  ...
  IXMLDocumentDisp = dispinterface
    ...
    function createElement(vType: OleVariant;
      var1: OleVariant): IXMLElement; dispid 65644;
  end;
  ...
  IXMLElement = interface(IDispatch)
    ...
    procedure setAttribute(const strPropertyName: WideString;
      PropertyValue: OleVariant); safecall;
    function getAttribute(
      const strPropertyName: WideString): OleVariant; safecall;
    ...
    procedure addChild(const pChildElem: IXMLElement; lIndex: Integer;
      lReserved: Integer); safecall;
  ...
  IXMLElementDisp = dispinterface
    ...
    procedure setAttribute(const strPropertyName: WideString;
      PropertyValue: OleVariant); dispid 65739;
    function getAttribute(
      const strPropertyName: WideString): OleVariant; dispid 65740;
    ...
    procedure addChild(const pChildElem: IXMLElement; lIndex: Integer;
      lReserved: Integer); dispid 65745;
  ...
  IXMLDocument2 = interface(IDispatch)
    ...
    function createElement(vType: OleVariant; var1: OleVariant;
      out ppElem: IXMLElement2): HResult; stdcall;
  ...
  IXMLElement2 = interface(IDispatch)
    ...
    function Get_text: WideString; safecall;
    procedure Set_text(const p: WideString); safecall;
    procedure addChild(const pChildElem: IXMLElement2; lIndex: Integer;
      lReserved: Integer); safecall;
...
class function CoDOMDocument.CreateRemote(
  const MachineName: string): IXMLDOMDocument;
begin
  Result := CreateRemoteComObject(WideString(MachineName),
    CLASS_DOMDocument) as IXMLDOMDocument;
end;
...
class function CoDOMFreeThreadedDocument.CreateRemote(
  const MachineName: string): IXMLDOMDocument;
begin
  Result := CreateRemoteComObject(WideString(MachineName),
    CLASS_DOMFreeThreadedDocument) as IXMLDOMDocument;
end;
...
class function CoXMLHTTPRequest.CreateRemote(
  const MachineName: string): IXMLHttpRequest;
begin
  Result := CreateRemoteComObject(WideString(MachineName),
    CLASS_XMLHTTPRequest) as IXMLHttpRequest;
end;
...
class function CoXMLDSOControl.CreateRemote(
  const MachineName: string): IXMLDSOControl;
begin
  Result := CreateRemoteComObject(WideString(MachineName),
    CLASS_XMLDSOControl) as IXMLDSOControl;
end;
...
class function CoXMLDocument.CreateRemote(
  const MachineName: string): IXMLDocument2;
begin
  Result := CreateRemoteComObject(WideString(MachineName),
    CLASS_XMLDocument) as IXMLDocument2;
end;
